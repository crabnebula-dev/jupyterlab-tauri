...
# 'shell_command': '/bin/zsh -i; VIRTUAL_ENV_PROMPT=(.venv)' 
# }
# c.ServerApp.terminado_settings = {
# 'shell_command': ['C:\\ProgramData\\Gennaker\\Resources\\Git\\bin\\bash.exe']
# }
...
#  Choices: any of ['sha384', 'blake2s', 'sha3_256', 'sha3_384', 'sha512', 'sha224', 'md5', 'blake2b', 'sha3_512', 'sha1', 'sha3_224', 'sha256']
#  Default: 'sha256'
